...
{
public:
    explicit SpectrumAnalyzer (SurgicalDeEsserAudioProcessor& p);
    void paint (juce::Graphics& g) override;
...
private:
    ...
    // Interruptores para mostrar/ocultar cada gráfica por separado
    juce::ToggleButton showSpectrumButton { "Espectro" };
    juce::ToggleButton showEqCurveButton { "Curva EQ" };
...
// ============================================================================
// Panel plegable del EQ de voces (6 bandas), colapsado por defecto.
// ============================================================================
class VocalEqBandControl : public juce::Component
{
public:
    VocalEqBandControl (SurgicalDeEsserAudioProcessor& proc, int bandIndex);
    void resized() override;
    void paint (juce::Graphics& g) override;
...
class VocalEqPanel : public juce::Component
{
public:
    explicit VocalEqPanel (SurgicalDeEsserAudioProcessor& proc);
    void resized() override;
    void paint (juce::Graphics& g) override;

private:
    juce::OwnedArray<VocalEqBandControl> bands;
...
private:
    ...
    juce::TextButton eqToggleButton;
    VocalEqPanel vocalEqPanel;
    bool eqExpanded = false;
    void updateEqPanelVisibility();
